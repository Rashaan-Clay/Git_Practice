/**
 * @file unity.h
 * @brief Header file for Unity Project unit testing framework
...
// NOLINTBEGIN
 ...
 // WVU CTest: Display in color for non-Mac systems
#ifndef __APPLE__
    #define UNITY_OUTPUT_COLOR
#endif

// WVU CTest: Enable double-precision numbers
#define UNITY_INCLUDE_DOUBLE

// WVU CTest: Use fflush for flushing output to avoid duplicate entries when output redirected to file
